...
function Dashboard() {
  ...
  const fetchReports = async () => {
    try {
      ...
      const res = await axios.get(
        "https://solar-checker-api.onrender.com/api/reports/my-reports",
        {
          headers: {
  ...
  const deleteReport = async (id) => {
    try {
      ...
      await axios.delete(
        `https://solar-checker-api.onrender.com/api/reports/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`
          }
            ...
            <div key={report.id} className="report-card">
              ...
              <div className="report-stats">
                <div className="r-stat">
                  ...
                  <span className="r-value gold">
                    ₹{Number(report.annual_savings).toLocaleString()}
                  </span>
                </div>
                ...
                <div className="r-stat">
                  ...
                  <span className="r-value green">
                    {Number(report.co2_offset).toLocaleString()} kg
                  </span>
                </div>
                ...
                <div className="r-stat">
                  ...
                  <span className="r-value gold">
                    ₹{Number(report.lifetime_savings).toLocaleString()}
                  </span>
                </div>
              </div>
            </div>
